        ...
        if paragraph_count <= 0:
            ...
            while add_bottle:
                ...
                if world[temp_bottle_location] == '0':
                    ...
                    add_bottle = False
        elif mode == 'endgame': # boat does not exist anymore after eating because it is replaced again by fish in same location
            print("hello")
            world[14] = '4'
            world[15] = '4'
        else:
...
def main():
    default_world = '100000030000010000000200000000000001'
    food = 18
    move_count = 0
    paragraph_count = 0
    alive = True
